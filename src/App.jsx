      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <button
              onClick={() => handleNav("donate")}
              className="mt-3 w-full py-3 bg-[#1a4731] text-white font-bold rounded-xl text-sm"
            >
              Donate Now
            </button>
          </motion.div>
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-5 py-20 w-full grid lg:grid-cols-2 gap-14 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <img src="/images/community.jpg" alt="Community outreach" className="w-full h-72 lg:h-[440px] object-cover rounded-2xl" />
      ...
      <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center">
        <FadeIn direction="right">
          <div className="relative">
            <img src="/founder.jpg" alt="Reverend Peter Olaleye" className="w-full h-96 rounded-2xl object-cover" />
...
function Footer() {
  return (
    <footer style={{ background: "linear-gradient(160deg, #0a1f15 0%, #0f2d1f 60%, #122a1c 100%)", color: "#fff" }}>
      ...
      {/* ── CTA Banner ── */}
      <div className="border-b border-white/7 bg-white/2">
        <div className="max-w-6xl mx-auto px-5 py-14 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-white mb-2 leading-snug" style={{ fontFamily: "'Georgia', serif" }}>
          ...
          <div className="flex gap-3 flex-shrink-0 flex-wrap">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => scrollTo("donate")}
              className="px-6 py-3 bg-white text-[#0f2d1f] font-bold rounded-full text-sm"
            >
              Donate Now
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => scrollTo("involved")}
              className="px-6 py-3 bg-white/10 border border-white/25 text-white font-bold rounded-full text-sm"
            >
              Get Involved
            </motion.button>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-5 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        {/* Contact col */}
        <div>
          <p className="text-xs font-bold tracking-widest uppercase text-white/30 mb-4 pb-2.5 border-b border-white/7">
            Contact Us
          </p>
          ...
          <ul className="space-y-0.5">
            {quickLinks.map(({ label, id }) => (
              <li key={id}>
                ...
                >
                  <span className="w-1 h-1 rounded-full bg-white/20 group-hover:bg-[#86c99e] transition-colors flex-shrink-0" />
                  {label}
                </button>
              </li>
            ))}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mb-6">
            {socials.map((s) => (
              <motion.a
                ...
                whileHover={{ y: -2, backgroundColor: "rgba(134,201,158,0.15)", borderColor: "rgba(134,201,158,0.3)" }}
                className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-xs font-semibold text-white/60 cursor-pointer transition-colors"
          ...
          <div className="rounded-2xl p-4" style={{ background: "rgba(134,201,158,0.08)", border: "1px solid rgba(134,201,158,0.18)" }}>
            ...
            <p className="text-xs leading-relaxed" style={{ color: "rgba(134,201,158,0.7)" }}>
              Head Pastor · New Estate Baptist Church<br />
              President · OCYF Ogbomoso
            </p>
          </div>
        </div>
